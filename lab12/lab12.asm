...
; R0 contains 0 (registers contain zero after reset) CHANGE: This cannot be assumed, so will add
; immediate 0 in program instead of using R0
...
INNERLOOP   ADD   R5,R5,R1            ; Increment sum
            ...
            ST   R1,ANS             ; This address contains X!          
            TRAP x25

INPUT      .FILL  x0005               ; Input for X!, in this case X = 5
ZERO       .FILL  x0000
NEG        .FILL  xFFFF               ; 2's complement of 1 (i.e. -1)
ANS        .FILL  x0000               ; At program completion, the result is
                                      ;   stored here
	   .END
